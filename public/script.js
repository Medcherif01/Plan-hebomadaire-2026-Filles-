        ...
        // Admins qui voient toutes les données
        const adminUsers = ['Mohamed', 'Zohra', 'Imad'];
        ...
        const translations = {
            fr: { 
                ...
                generate_all_plans_button: "Générer Plans de Leçon (Affichés)",
            ...
            ar: { 
                ...
                generate_all_plans_button: "إنشاء خطط الدروس (المعروضة)",
            ...
            en: { 
                ...
                generate_all_plans_button: "Generate Lesson Plans (Displayed)",
        ...
        function initializeApp(username) {
            ...
            // Déterminer la langue AVANT tout le reste
            if (arabicTeachers.includes(loggedInUser)) { 
